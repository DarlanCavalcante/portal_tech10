...
(function () {
  ...
  const CATEGORIES = [
    {
      name: 'Tecnologia',
      stores: [
        { id: 'tech10', name: 'Tech10', slug: 'revivah-tech', desc: 'Informática e tecnologia', bannerUrl: '/imagem/logo/tech10-logo-fundo-azul.png', logoUrl: '/imagem/logo/tech10-logo-fundo-azul.png' },
  ...
  function getStoreHref(store) {
    if (store.slug === 'revivah-tech') return '/';
